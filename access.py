...
def processing_fn(datapoints):
    for stock in single:
        ...
        for value in portfolio:
            ...
            for i in range(len(dummy_.data.size) - len(obj_.data)):
            ...
            print("max correlation", corr_ds.max(), "occurs at lag", lag_true, "with MSE: ",
                  np.square(np.subtract(dummy_.data, obj_.data)).mean())
